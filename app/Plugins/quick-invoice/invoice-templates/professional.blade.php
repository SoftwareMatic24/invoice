<div class="header">
	<div class="left">
		<div class="left-col">
			<p class="clr-seconary-400">{{ strtoupper($documentTypeText) }}#</p>
			<p class="clr-seconary-400">Reference</p>
		</div>
		<div class="left-col">
			<p>{{ $documentNumber ?? "" }}</p>
			<p>{{ $referenceNumber ?? "" }}</p>
		...
		<div class="left-col">
			<p class="clr-seconary-400">DATE</p>
			@if($dueDate)
			<p class="clr-seconary-400">{{ $documentType === 'delivery-note' ? 'DELIVERY DATE' : 'DUE DATE' }}</p>
			@endif
		</div>
		<div class="left-col">
			<p>{{ $issueDate ?? "" }}</p>
...
@if($salutation)
<div>
	<p class="text-group-text | margin-top-4" style="max-width: 40ch;">
		{{ $salutation ?? "" }}
	</p>
</div>
@endif

<div class="text-group | margin-top-4 margin-bottom-2">
	<div class="text-group-col">
		<p class="text-group-heading">{{ $documentTypeText }} to:</p>
...
<div class="text-group-2 | margin-bottom-2">
